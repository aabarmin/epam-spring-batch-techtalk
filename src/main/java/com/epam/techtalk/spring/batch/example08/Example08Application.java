...
public class Example08Application {
    public static void main(String[] args) throws Exception {
        final ClassPathXmlApplicationContext context =
                new ClassPathXmlApplicationContext("example08/example08.xml");
        ...
        final CustomItemReaderListener readerListener =
                context.getBean("readerListener", CustomItemReaderListener.class);

        System.out.println("Items were read: " + readerListener.getReadTotal());

        final CustomItemWriterListener writerListener =
                context.getBean("writerListener", CustomItemWriterListener.class);
